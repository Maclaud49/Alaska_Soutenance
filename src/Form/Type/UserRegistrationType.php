    ...
    public function buildForm(FormBuilderInterface $builder, array $options) {
        $builder
            ->add('username', TextType::class, array(
                'label'       => "Pseudo",
                'required'    => true,
                'constraints' => new Assert\NotBlank(array('message' => 'Merci de renseigner votre pseudo')),
            ))
            ...
            ->add('email', TextType::class, array(
                ...
                'required'    => true,
                'constraints' => array(
                    new Assert\Email(array('message' => 'L\'adresse email n\'est pas correcte')),
                    new Assert\NotBlank(array('message' => 'l\'adresse email est vide'))),
            ))
